...
\logo{\includegraphics[height=1cm]{figures/LANL_logo.png}}
...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.70\textwidth}
         \centering
         \includegraphics[width=\textwidth]{figures/thanks/Oppenheimer.png}
     \end{subfigure}
\end{figure}
...
\begin{figure}
         \centering
         \includegraphics[width=0.80\textwidth]{figures/thanks/GhostRanch.png}
\end{figure}
...
%     \begin{subfigure}[b]{0.30\textwidth}
%         \centering
%         \includegraphics[width=\textwidth]{figures/thanks/GhostRanch.png}
%     \end{subfigure}
%     \begin{subfigure}[b]{0.30\textwidth}
%         \centering
%         \includegraphics[width=\textwidth]{figures/thanks/Oppenheimer.png}
