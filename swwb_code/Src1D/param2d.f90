...
MODULE param2d
  ...
  TYPE donnees
     ...
     INTEGER :: ijump !*jump chosen -> 1=conserved variables, 2=eta, 3=entropy, 4=residuals
     LOGICAL:: staggering=.FALSE.
     INTEGER:: iGlobalFlux=0
     ...
     INTEGER:: perturbation !*perturbation
